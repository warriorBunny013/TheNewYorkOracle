...
const BookingSlotMentorship = () => {
  ...
  useEffect(() => {
    if (isAuthorized) {
      // const appointlet = new Appointlet('https://appt.link/meet-with-marina-kLDXzYpH/mentorship-programme');
...
export default BookingSlotMentorship;