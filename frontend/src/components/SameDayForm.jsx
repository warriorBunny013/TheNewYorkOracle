    ...
    <div className="grid grid-cols-1 gap-x-8 gap-y-8 lg:grid-cols-5">
      <div className="lg:col-span-2 lg:py-12">
        ...
        <ul className="list mt-6 sm:mt-10 flex flex-col gap-2">
            ...
            {/* <li>🌺 LIVE 45-minute reading: Reading is a first come, first serve within the next few business days(Delivery within 72 hours) </li> */}
          ...
          <div className="grid grid-cols-1 gap-4 text-center sm:grid-cols-2">
            <div>
              ...
              >
                ...
                tabIndex="-1" 
                name="readingtype"
                value="Pre-recorded session ($350)"
                onChange={handleChange}
                disabled={isCompleted}
                // name="option" 
                required />

                <span className="text-xs sm:text-sm"> Pre-recorded session ($350)  </span>
              </label>
            </div>
            ...
            {/* <div>
              ...
              >
                ...
                // name="option" 
                name="readingtype"
                value="Live 45mins one-on-one reading ($495)"
                onChange={handleChange}
                disabled={isCompleted}
                required />
