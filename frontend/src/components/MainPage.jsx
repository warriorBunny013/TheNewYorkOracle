...
{/* HERO SECTION ENDS FROM HERE!! */}
      ...
      <footer className="bg-white  dark:bg-gray-800">
        <div className='w-full mx-auto max-w-screen-xl p-4 md:flex gap-3 md:items-center md:justify-between'>
          <div className='max-w-1/2 mb-10 text-sm text-gray-400'><span className='font-bold'>Disclaimer:</span> By purchasing you are acknowledging and understanding that Marina is a professional tarot reader and not a doctor. This is for entertainment purposes only, and if you need professional medical help, you will take the proper steps for yourself. You also understand and agree you will take full responsibility for your actions and cannot blame Marina or Soulstice Tarot for any decisions you make moving forward.</div>
        </div>
    <div className="w-full mx-auto  max-w-screen-xl p-4 md:flex gap-3 md:items-center md:justify-between">
